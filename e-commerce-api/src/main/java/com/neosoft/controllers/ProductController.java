...
public class ProductController {
	...
	public ResponseEntity<Product> registerNewProductHandler(@RequestBody Product product) throws ProductException {
	...
	public ResponseEntity<Product> updateProductById(@PathVariable("productid") Integer productId,@RequestBody Product product) throws ProductException {
	...
	public ResponseEntity<Product> deleteProductById(Integer productId) throws ProductException {
